	...
	**--------------------------------------------------------------------------------------------------------*/
	public partial class Справка
	{
		...
		**-----------------------------------------------------------------------------------------------------------*/
		...
		private void Справка_Shown(object sender, EventArgs e)
		{
			ActiveControl = m_textControl;
			// Calculate the DPI
			// before using the ResourceProvider for getting the images.
			...
			// Init and localize the ribbon by setting images dependly on the DPI and 
			// by setting the texts dependly on the culture.
			m_textControl.PageMargins.Left = 98.4;
			m_textControl.PageMargins.Top = 48;
			//боцман.справка.m_textControl.PageMargins.Top = 59.04;

			m_textControl.PageMargins.Right = 35; // 100
			//m_textControl.PageMargins.Right = 31.488; // 80
			//m_textControl.PageMargins.Right = 39.36; // 100
		}
