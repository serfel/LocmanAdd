	...
	public partial class MainWindow {
		...
		**----------------------------------------------------------------------------------------------*/
		private void AddFinishGroup() {
			...
			{
				Text = Лоцман_добавка.Properties.Resources.HEADER_FinishGroup,
		...
		**----------------------------------------------------------------------------------------------*/
		private void AddPreviewButton() {
			...
			{
				Text = Лоцман_добавка.Properties.Resources.LABEL_Preview,
				KeyTip = Лоцман_добавка.Properties.Resources.KEYTIP_Preview,
				SmallIcon = Images.GetSmallIcon("Preview"),
				LargeIcon = Images.GetLargeIcon("Preview"),
				DisplayMode = IconTextRelation.LargeIconLabeled,
			};
			TXITEM_Preview.ToolTip.Title = Лоцман_добавка.Properties.Resources.TOOLTIPTITLE_Preview;
			TXITEM_Preview.ToolTip.Description = Лоцман_добавка.Properties.Resources.TOOLTIP_Preview;
		...
		**----------------------------------------------------------------------------------------------*/
		private void AddFinishAndMergeButton() {
			...
			{
				Text = Лоцман_добавка.Properties.Resources.LABEL_FinishAndMerge,
				KeyTip = Лоцман_добавка.Properties.Resources.KEYTIP_FinishAndMerge,
				SmallIcon = Images.GetSmallIcon("FinishAndMerge"),
				LargeIcon = Images.GetLargeIcon("FinishAndMerge")
			};
			TXITEM_FinishAndMerge.ToolTip.Title = Лоцман_добавка.Properties.Resources.TOOLTIPTITLE_FinishAndMerge;
			TXITEM_FinishAndMerge.ToolTip.Description = Лоцман_добавка.Properties.Resources.TOOLTIP_FinishAndMerge;
		...
		**----------------------------------------------------------------------------------------------*/
		private void AddFinishAndMergeMenu(RibbonSplitButton splitButton) {
			...
			{
				Text = Лоцман_добавка.Properties.Resources.HEADER_FinishAndMerge_IntoCurrentDocument,
				SmallIcon = Images.GetSmallIcon("FinishAndMerge_IntoCurrentDocument"),
				DisplayMode = IconTextRelation.SmallIconLabeled
			};
			TXITEM_FinishAndMerge_IntoCurrentDocument.ToolTip.Title = Лоцман_добавка.Properties.Resources.TOOLTIPTITLE_FinishAndMerge_IntoCurrentDocument;
			TXITEM_FinishAndMerge_IntoCurrentDocument.ToolTip.Description = Лоцман_добавка.Properties.Resources.TOOLTIP_FinishAndMerge_IntoCurrentDocument;
			...
			{
				Text = Лоцман_добавка.Properties.Resources.HEADER_FinishAndMerge_IntoSingleFile,
				SmallIcon = Images.GetSmallIcon("FinishAndMerge_IntoSingleFile"),
				DisplayMode = IconTextRelation.SmallIconLabeled
			};
			TXITEM_FinishAndMerge_IntoSingleFile.ToolTip.Title = Лоцман_добавка.Properties.Resources.TOOLTIPTITLE_FinishAndMerge_IntoSingleFile;
			TXITEM_FinishAndMerge_IntoSingleFile.ToolTip.Description = Лоцман_добавка.Properties.Resources.TOOLTIP_FinishAndMerge_IntoSingleFile;
			...
			{
				Text = Лоцман_добавка.Properties.Resources.HEADER_FinishAndMerge_IntoIndividualDocument,
				SmallIcon = Images.GetSmallIcon("FinishAndMerge_IntoIndividualDocument"),
				DisplayMode = IconTextRelation.SmallIconLabeled
			};
			TXITEM_FinishAndMerge_IntoIndividualDocument.ToolTip.Title = Лоцман_добавка.Properties.Resources.TOOLTIPTITLE_FinishAndMerge_IntoIndividualDocument;
			TXITEM_FinishAndMerge_IntoIndividualDocument.ToolTip.Description = Лоцман_добавка.Properties.Resources.TOOLTIP_FinishAndMerge_IntoIndividualDocument;
			...
			{
				Text = Лоцман_добавка.Properties.Resources.HEADER_FinishAndMerge_PrintDocument,
				SmallIcon = Images.GetSmallIcon("FinishAndMerge_PrintDocument"),
				DisplayMode = IconTextRelation.SmallIconLabeled
			};
			TXITEM_FinishAndMerge_PrintDocument.ToolTip.Title = Лоцман_добавка.Properties.Resources.TOOLTIPTITLE_FinishAndMerge_PrintDocument;
			TXITEM_FinishAndMerge_PrintDocument.ToolTip.Description = Лоцман_добавка.Properties.Resources.TOOLTIP_FinishAndMerge_PrintDocument;
		...
		**----------------------------------------------------------------------------------------------*/
		private void AddMergeIntoSeparateFilesMenu(RibbonMenuButton menuButton) {
			...
			AddMergeIntoMenuButtons(
				menuButton,
				Лоцман_добавка.Properties.Resources.BTN_MERGE_INTO_INDIV_X_FILES_TOOLTIP,
		...
		**----------------------------------------------------------------------------------------------*/
		private void MergeIntoCurrentDocument() {
			...
			if (mergeResult.Count == 0) {
				Utils.MessageBox.Show(this, Лоцман_добавка.Properties.Resources.MERGE_NO_MERGE_RESULTS,
					"Боцман", MessageBoxButtons.OK, MessageBoxIcon.Information);
				return;
			}
		...
		private void SetLastSelectedMasterTable() {
			...
			foreach (Control dropDownItem in rmbtnTXITEM_SelectMasterTable.DropDownItems) {
				...
				if (rtbnTable != null && rtbnTable.Checked) {
					m_reportingTab.DataSourceManager.MasterDataTableInfo = rtbnTable.Tag as DocumentServer.DataSources.DataTableInfo;
					break;
				}
			}
		}
		...
		public static string ToFilterString(this StreamType streamType) {
			switch (streamType) {
				...
				case StreamType.AdobePDFA:
					return Лоцман_добавка.Properties.Resources.APP_MENU_SAVE_AS_PDF + "|*.pdf";

				case StreamType.HTMLFormat:
					return Лоцман_добавка.Properties.Resources.APP_MENU_SAVE_AS_HTML + "|*.htm;*.html";

				case StreamType.InternalFormat:
				case StreamType.InternalUnicodeFormat:
					return Лоцман_добавка.Properties.Resources.APP_MENU_SAVE_AS_TX + "|*.tx";

				case StreamType.MSWord:
					return Лоцман_добавка.Properties.Resources.APP_MENU_SAVE_AS_DOC + "|*.doc";

				case StreamType.PlainAnsiText:
				case StreamType.PlainText:
					return Лоцман_добавка.Properties.Resources.APP_MENU_SAVE_AS_TXT + "|*.txt";

				case StreamType.RichTextFormat:
					return Лоцман_добавка.Properties.Resources.APP_MENU_SAVE_AS_RTF + "|*.rtf";

				case StreamType.WordprocessingML:
					return Лоцман_добавка.Properties.Resources.APP_MENU_SAVE_AS_DOCX + "|*.docx";
			}
