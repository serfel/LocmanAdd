	...
	public partial class UserAdminDialog : Form {
		...
		private void BtnEdit_Click(object sender, EventArgs e) {
			...
			if (dlg.ShowDialog(this) == System.Windows.Forms.DialogResult.OK) {
				...
				if (!dlg.Username.Equals(userInfo.Name, StringComparison.OrdinalIgnoreCase) && m_users.Any(ui => ui.Name.Equals(dlg.Username, StringComparison.OrdinalIgnoreCase))) {
					Utils.MessageBox.Show(this, Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_USER_EXISTS, "Боцман", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				}
				else {
			...
			if (dlg.ShowDialog(this) == System.Windows.Forms.DialogResult.OK) {
				if (m_users.Any(ui => ui.Name.Equals(dlg.Username, StringComparison.OrdinalIgnoreCase))) {
					...
					Utils.MessageBox.Show(this,
						Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_USER_EXISTS, 
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void LocalizeDialog() {
			this.Text = Лоцман_добавка.Properties.Resources.USER_ADMIN_DLG_TITLE;
			m_btnOK.Text = Лоцман_добавка.Properties.Resources.BTN_OK;
			m_btnCancel.Text = Лоцман_добавка.Properties.Resources.BTN_CANCEL;
			m_btnDelete.Text = Лоцман_добавка.Properties.Resources.USER_ADMIN_DLG_BTN_DELETE;
			m_btnNew.Text = Лоцман_добавка.Properties.Resources.USER_ADMIN_DLG_BTN_NEW;
			m_btnEdit.Text = Лоцман_добавка.Properties.Resources.USER_ADMIN_DLG_BTN_EDIT;
			m_lblUsers.Text = Лоцман_добавка.Properties.Resources.USER_ADMIN_DLG_LBL_USERS;
		}
	}
}
