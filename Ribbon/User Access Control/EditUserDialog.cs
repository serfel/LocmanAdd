	...
	public partial class EditUserDialog : Form {
		...
		**-----------------------------------------------------------------------------------------------------*/
		public bool RequestCurrentPassword {
			...
			set {
				...
				m_lblNewPassword.Text = value ? Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_LBL_NEW_PASSWORD : Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_LBL_PASSWORD;
		...
		**-----------------------------------------------------------------------------------------------------*/
		private void BtnOK_Click(object sender, EventArgs e) {
			if (m_requestCurrentPwd && !m_userInfo.ValidatePassword(m_txtCurrentPassword.Text)) {
				Utils.MessageBox.Show(this, Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_WRONG_PASSWORD, "Боцман", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				return;
			}
		...
		**-----------------------------------------------------------------------------------------------------*/
		private void LocalizeDialog() {
			this.Text = Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_TITLE;
			m_btnOK.Text = Лоцман_добавка.Properties.Resources.BTN_OK;
			m_btnCancel.Text = Лоцман_добавка.Properties.Resources.BTN_CANCEL;
			m_lblName.Text = Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_LBL_USER_NAME;
			m_lblNewPassword.Text = Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_LBL_PASSWORD;
			m_lblCurrentPassword.Text = Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_LBL_PASSWORD;
			m_lblPasswordConfirm.Text = Лоцман_добавка.Properties.Resources.EDIT_USER_DLG_LBL_PASSWORD_CONFIRM;
		}
	}
}
