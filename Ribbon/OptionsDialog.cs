	...
	public partial class OptionsDialog : Form {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void LocalizeDialog() {
			// Window title
			Text = Лоцман_добавка.Properties.Resources.OPT_DLG_TITLE;
			...
			// Tab pages
			m_tabPageHTML.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_TAB_HTMLOPTS;
			m_tabPagePDFSecurity.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_TAB_PDFSEC;
			m_tabPagePDFExport.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_TAB_PDFEXP;
			m_tabPagePDFImport.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_TAB_PDFIMP;

			// HTML options
			m_grpCSS.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_CSS_GRP_SAVEOPTS;
			m_optNoStylesheet.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_CSS_NONE;
			m_optInlineStylesheet.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_CSS_INLINE;
			m_optSaveStylesheetInSeperateFile.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_CSS_SEPARATE_FILE;
			m_optSaveButDoNotOverwriteExistingFile.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_CSS_SAVE_NOT_OVR;
			m_lblStylesheetFile.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_CSS_LBL_FILE;

			// PDF security
			m_grpPDFDigSig.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFSEC_GRP_DIG_SIG;
			m_grpPDFDocPwd.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFSEC_GRP_DOC_PWD;
			m_lblCertFile.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFSEC_LBL_CERT_FILE;
			m_lblCertPwd.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFSEC_LBL_CERT_PWD;
			m_chkUserPassword.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFSEC_REQ_DOC_PWD;
			m_lblDocumentPassword.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFSEC_LBL_DOC_PWD;

			// PDF import
			m_grpPDFImport.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFIMP_GRP_OPTS;
			m_lblPDFImportMode.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFIMP_LBL_MODE;
			m_chbxLoadEmbeddedFiles.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFIMP_MODE_EMBEDDEDFILES;
			m_chbxLoadAdditionalEmbeddedData.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFIMP_MODE_ADDITIONAL_EMBEDDED_DATA;

			// PDF export
			m_grpPDFExport.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFEXP_GRP_OPTS;
			m_chkPDFEmbeddableFontsOnly.Text = Лоцман_добавка.Properties.Resources.OPT_DLG_PDFEXP_ENABLE_PDFA;
		}//LocalizeDialog
			...
			if (m_txtCertFile.Text != "") {
				try {
					...
					Utils.MessageBox.Show(this,
						string.Format(Лоцман_добавка.Properties.Resources.EXC_PDF_SIGNATURE, exc.Message),
						"Боцман", MessageBoxButtons.OK, MessageBoxIcon.Error);
					return;
				}
			}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private bool ValidateDialogContent() {
			if (m_chkUserPassword.Checked && m_txtUserPassword.Text.Length == 0) {
				Utils.MessageBox.Show(this, Лоцман_добавка.Properties.Resources.OPT_DLG_PDFSEC_ERR_NO_DOC_PWD, "Боцман");
				return false;
			}
			return true;
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void OptionsDialog_Load(object sender, System.EventArgs e) {
			...
			m_cbPDFImportMode.Items.Add(Лоцман_добавка.Properties.Resources.OPT_DLG_PDFIMP_MODE_FRAMES);
			m_cbPDFImportMode.Items.Add(Лоцман_добавка.Properties.Resources.OPT_DLG_PDFIMP_MODE_PAR);
			m_cbPDFImportMode.Items.Add(Лоцман_добавка.Properties.Resources.OPT_DLG_PDFIMP_MODE_PLAIN);
