	...
	public partial class MainWindow {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		void BtnAppMenu_Save_Click(object sender, EventArgs e) 
		{
			if (this.OutPath != "")
			{
				if (!Directory.Exists(System.Windows.Forms.Application.StartupPath + $@"\Справки\{DateTime.Now.Year}"))
					Directory.CreateDirectory(System.Windows.Forms.Application.StartupPath + $@"\Справки\{DateTime.Now.Year}");
				string filename = System.Windows.Forms.Application.StartupPath + $@"\Справки\{DateTime.Now.Year}\" + this.OutPath;
