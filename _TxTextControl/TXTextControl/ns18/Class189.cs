...
namespace ns18
{
	internal class Class189 : ShapeObject
	{
		...
		public Class189(Shape shape_0)
		{
			...
			base.adj5 = Helper.FmlaLiteralValue(100000.0);
			base.adj6 = Helper.FmlaLiteralValue(-16667.0);
			base.adj7 = Helper.FmlaLiteralValue(112963.0);
			base.adj8 = Helper.FmlaLiteralValue(-8333.0);
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_17 = Helper.FmlaMultiplyDivide(base.double_1, base.adj7, 100000.0);
			this.double_18 = Helper.FmlaMultiplyDivide(base.double_8, base.adj8, 100000.0);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				adjustObject.DefaultValue = 18750.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj6")) ? (-16667.0) : base.adj6);
				...
				adjustObject.DefaultValue = -16667.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj5")) ? 100000.0 : base.adj5);
				...
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj8")) ? (-8333.0) : base.adj8);
				adjustObject = new Class170(new Class177(this.double_18 / 12700.0, this.double_17 / 12700.0, bool_1: false), "Adj8", -2147483647.0, 2147483647.0, num, base.shape, bool_0: false);
				adjustObject.DefaultValue = -8333.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj7")) ? 112963.0 : base.adj7);
				adjustObject = new Class171(new Class177(this.double_18 / 12700.0, this.double_17 / 12700.0, bool_1: false), "Adj7", -2147483647.0, 2147483647.0, num, base.shape, bool_0: false);
				adjustObject.DefaultValue = 112963.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				...
				base.shape.Class174_0.Class172_0[6].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_18 / 12700.0, this.double_17 / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[7].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_18 / 12700.0, this.double_17 / 12700.0, bool_1: false);
			}
			...
			class2 = DrawHelper.MoveTo(this.double_12, base.t);
			DrawHelper.Close(graphicsPath);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_18, this.double_17);
			@class.List_0.Add(graphicsPath);
			array[2] = @class;
