...
namespace ns18
{
	internal class Class360 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_12 = Helper.FmlaMultiplyDivide(base.double_8, this.double_11, 200000.0);
			this.double_13 = Helper.FmlaMultiplyDivide(base.double_8, this.double_11, 100000.0);
			this.double_14 = Helper.FmlaAddSubtract(this.double_12, base.wd2, 0.0);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class170(new Class177(this.double_13 / 12700.0, base.t / 12700.0, bool_1: false), "Adj", 0.0, 100000.0, num, base.shape, bool_0: false);
