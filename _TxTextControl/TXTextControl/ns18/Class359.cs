...
namespace ns18
{
	internal class Class359 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_16 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_13);
			this.double_17 = Helper.FmlaMultiplyDivide(base.wd3, this.double_12, this.double_11);
			this.double_18 = Helper.FmlaMultiplyDivide(base.hd3, this.double_12, this.double_11);
			this.double_19 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_17);
