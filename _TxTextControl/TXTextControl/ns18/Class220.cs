...
namespace ns18
{
	internal class Class220 : ShapeObject
	{
		public Class220(Shape shape_0)
		{
			base.shape = shape_0;
		...
		internal override void CreateGraphicsPaths()
		{
			...
			Class177 class2 = DrawHelper.MoveTo(63500.0, 0.0);
			class2 = DrawHelper.LnTo(newGraphicPath, class2.Double_2, class2.Double_3, 63500.0, 127000.0);
			class2 = DrawHelper.MoveTo(0.0, 63500.0, newGraphicPath, @class, out newGraphicPath);
			class2 = DrawHelper.LnTo(newGraphicPath, class2.Double_2, class2.Double_3, 127000.0, 63500.0);
