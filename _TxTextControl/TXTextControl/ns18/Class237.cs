...
namespace ns18
{
	internal class Class237 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_17 = Helper.FmlaAddSubtract(base.hd2, 0.0, this.double_16);
			...
			this.double_23 = Helper.FmlaMultiplyDivide(this.double_22, base.double_8, this.double_18);
			...
			this.double_26 = Helper.FmlaMultiplyDivide(base.double_6, this.double_25, 100000.0);
			this.double_27 = Helper.FmlaAddSubtract(this.double_17, this.double_14, 0.0);
			this.double_28 = Helper.FmlaMultiplyDivide(base.double_8, base.double_8, 1.0);
			...
			this.double_32 = Helper.FmlaMultiplyDivide(this.double_31, this.double_17, base.double_8);
			...
			this.double_41 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_26);
			this.double_42 = Helper.FmlaArcTan(this.double_26, this.double_32);
			this.double_43 = Helper.FmlaAddSubtract(base.cd2, 0.0, this.double_42);
			this.double_44 = Helper.FmlaAddSubtract(0.0, 0.0, this.double_42);
			this.double_45 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_23);
			this.double_46 = Helper.FmlaAddDivide(this.double_17, this.double_27, 2.0);
			this.double_47 = Helper.FmlaMultiplyDivide(this.double_14, 1.0, 2.0);
			this.double_48 = Helper.FmlaArcTan(this.double_23, this.double_47);
			this.double_49 = Helper.FmlaAddSubtract(this.double_48, 0.0, base.cd4);
			this.double_50 = Helper.FmlaAddSubtract(base.cd4, this.double_48, 0.0);
			this.double_51 = Helper.FmlaAddSubtract(base.cd2, 0.0, this.double_48);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class171(new Class177(this.double_41 / 12700.0, this.double_33 / 12700.0, bool_1: false), "Adj1", 0.0, this.double_12, num, base.shape, bool_0: true);
				...
				adjustObject = new Class171(new Class177(base.double_5 / 12700.0, this.double_37 / 12700.0, bool_1: false), "Adj2", 0.0, this.double_11, num, base.shape, bool_0: true);
				...
				adjustObject = new Class170(new Class177(this.double_41 / 12700.0, base.double_0 / 12700.0, bool_1: false), "Adj3", 0.0, this.double_24, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				base.shape.Class174_0.Class172_0[0].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_41 / 12700.0, this.double_33 / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[1].AdjustRectangle.Class178_0.Class177_1 = new Class177(base.double_5 / 12700.0, this.double_37 / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[2].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_41 / 12700.0, base.double_0 / 12700.0, bool_1: false);
			}
			...
			Class177 currentPathEndLocation = DrawHelper.MoveTo(base.double_3, this.double_17);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, base.cd2, this.double_44, currentPathEndLocation);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, this.double_41, this.double_37);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, base.double_5, this.double_40);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, this.double_41, this.double_38);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, this.double_41, this.double_34);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, this.double_43, this.double_42, currentPathEndLocation);
			DrawHelper.Close(graphicsPath);
			@class.List_0.Add(graphicsPath);
			array[0] = @class;
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: false, Enum32.const_1);
			currentPathEndLocation = DrawHelper.MoveTo(base.double_5, this.double_14);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, base._3cd4, this.double_49, currentPathEndLocation);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, this.double_51, this.double_50, currentPathEndLocation);
			DrawHelper.Close(graphicsPath);
			@class.List_0.Add(graphicsPath);
			array[1] = @class;
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: true, Enum32.const_4);
			currentPathEndLocation = DrawHelper.MoveTo(base.double_3, this.double_17);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, base.cd2, this.double_44, currentPathEndLocation);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, this.double_41, this.double_37);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, base.double_5, this.double_40);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, this.double_41, this.double_38);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, this.double_41, this.double_34);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, this.double_43, this.double_42, currentPathEndLocation);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, base.double_3, this.double_17);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, base.cd2, base.cd4, currentPathEndLocation);
