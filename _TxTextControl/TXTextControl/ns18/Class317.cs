...
namespace ns18
{
	internal class Class317 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_15 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_13);
			this.double_16 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_14);
			...
			this.double_19 = Helper.FmlaMultiplyDivide(base.wd2, this.double_12, this.double_11);
			this.double_20 = Helper.FmlaMultiplyDivide(5.0, this.double_12, this.double_11);
			this.double_21 = Helper.FmlaAddDivide(1.0, this.double_20, 12.0);
			this.double_19 = Helper.FmlaMultiplyDivide(this.double_21, base.double_8, 1.0);
			this.double_22 = Helper.FmlaMultiplyDivide(this.double_21, base.double_1, 1.0);
			this.double_23 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_19);
			this.double_24 = Helper.FmlaAddSubtract(base.double_0, 0.0, this.double_22);
			this.double_25 = Helper.FmlaMultiplyDivide(base.double_1, base.double_2, this.double_14);
			this.double_26 = Helper.FmlaPinTo(0.0, this.double_25, base.double_1);
