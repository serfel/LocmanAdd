...
namespace ns18
{
	internal class Class270 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			currentPathEndLocation = DrawHelper.MoveTo(base.double_2, base.t);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, base.double_2, base.double_0);
			currentPathEndLocation = DrawHelper.MoveTo(base.double_3, base.double_7, graphicsPath, @class, out graphicsPath);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, base.double_5, base.double_7);
			@class.List_0.Add(graphicsPath);
			array[1] = @class;
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: true, Enum32.const_4);
