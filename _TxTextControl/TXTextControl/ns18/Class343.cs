...
namespace ns18
{
	internal class Class343 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_3, this.double_12);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_12, this.double_13);
			...
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: true, Enum32.const_5);
			class2 = DrawHelper.MoveTo(this.double_14, base.t);
			...
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: true, Enum32.const_5);
			class2 = DrawHelper.MoveTo(this.double_14, this.double_13);
