...
namespace ns18
{
	internal class Class261 : ShapeObject
	{
		private double double_11;

		public Class261(Shape shape_0)
		{
			base.shape = shape_0;
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_11 = Helper.FmlaMultiplyDivide(base.double_8, 2.0, 3.0);
			...
			class2 = DrawHelper.ArcTo(graphicsPath, 12700.0, 38100.0, base._3cd4, base.cd2, class2);
			...
			class2 = DrawHelper.MoveTo(63500.0, 76200.0);
			class2 = DrawHelper.ArcTo(graphicsPath, 12700.0, 38100.0, base.cd4, base.cd2, class2);
			@class.List_0.Add(graphicsPath);
			array[1] = @class;
			graphicsPath = DrawHelper.PathBegin();
