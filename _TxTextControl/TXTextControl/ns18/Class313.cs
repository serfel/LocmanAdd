...
namespace ns18
{
	internal class Class313 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_12 = Helper.FmlaPinTo(0.0, base.adj1, this.double_11);
			this.double_13 = Helper.FmlaPinTo(0.0, base.adj2, this.double_11);
			this.double_14 = Helper.FmlaMultiplyDivide(base.double_6, this.double_12, 200000.0);
			...
			this.double_17 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_16);
			this.double_18 = Helper.FmlaAddDivide(base.double_5, this.double_17, 2.0);
			this.double_19 = Helper.FmlaMultiplyDivide(base.wd3, this.double_12, this.double_11);
			this.double_20 = Helper.FmlaMaximumValue(this.double_12, this.double_13);
			this.double_21 = Helper.FmlaMultiplyDivide(base.hd3, this.double_20, this.double_11);
			this.double_22 = Helper.FmlaMultiplyDivide(base.wd3, this.double_13, this.double_11);
			this.double_23 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_22);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class170(new Class177(this.double_15 / 12700.0, base.t / 12700.0, bool_1: false), "Adj1", 0.0, this.double_11, num, base.shape, bool_0: false);
				...
				adjustObject = new Class170(new Class177(this.double_17 / 12700.0, base.t / 12700.0, bool_1: false), "Adj2", 0.0, this.double_11, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				base.shape.Class174_0.Class172_0[0].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_15 / 12700.0, base.t / 12700.0, bool_1: false);
