...
namespace ns18
{
	internal class Class262 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_17 = Helper.FmlaArcTan(base.double_8, base.double_1);
			Class175[] array = new Class175[1];
			GraphicsPath graphicsPath = DrawHelper.PathBegin();
			Class175 @class = new Class175(bool_1: true, Enum32.const_5);
			Class177 currentPathEndLocation = DrawHelper.MoveTo(base.double_2, base.double_0);
			...
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.wd2, base.hd2, 0.0, this.double_17, currentPathEndLocation);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, base.double_5, this.double_16);
