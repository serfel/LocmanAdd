...
namespace ns18
{
	internal class Class294 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_19 = Helper.FmlaAddSubtract(this.double_18, this.double_17, 0.0);
			this.double_20 = Helper.FmlaCosine(base.wd2, 2700000.0);
			this.double_21 = Helper.FmlaSine(this.double_17, 2700000.0);
			this.double_22 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_20);
			this.double_23 = Helper.FmlaAddSubtract(this.double_17, 0.0, this.double_21);
			this.double_24 = Helper.FmlaAddSubtract(base.double_0, this.double_21, this.double_17);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				adjustObject = new Class171(new Class177(base.double_3 / 12700.0, this.double_18 / 12700.0, bool_1: false), "Adj2", 0.0, 100000.0, num, base.shape, bool_0: false);
			...
			else
			{
				...
				base.shape.Class174_0.Class172_0[1].AdjustRectangle.Class178_0.Class177_1 = new Class177(base.double_3 / 12700.0, this.double_18 / 12700.0, bool_1: false);
			}
			...
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.wd2, this.double_17, base.cd4, base.cd4, currentPathEndLocation);
			...
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.wd2, this.double_17, 0.0, -5400000.0, currentPathEndLocation);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.wd2, this.double_17, base.cd4, -5400000.0, currentPathEndLocation);
			currentPathEndLocation = DrawHelper.LnTo(graphicsPath, currentPathEndLocation.Double_2, currentPathEndLocation.Double_3, base.double_2, this.double_17);
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.wd2, this.double_17, base.cd2, base.cd4, currentPathEndLocation);
