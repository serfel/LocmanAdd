...
namespace ns18
{
	internal class Class236 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_41 = Helper.FmlaAddSubtract(base.double_3, this.double_26, 0.0);
			...
			this.double_44 = Helper.FmlaAddSubtract(base.double_3, this.double_23, 0.0);
			...
			this.double_49 = Helper.FmlaAddSubtract(this.double_42, this.double_47, 0.0);
			this.double_50 = Helper.FmlaAddSubtract(0.0, 0.0, this.double_47);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				adjustObject = new Class170(new Class177(this.double_41 / 12700.0, base.double_0 / 12700.0, bool_1: false), "Adj3", 0.0, this.double_24, num, base.shape, bool_0: false);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			...
			Class177 class2 = DrawHelper.MoveTo(base.double_3, this.double_40);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_41, this.double_37);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_41, this.double_33);
			class2 = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, this.double_42, this.double_48, class2);
			class2 = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, this.double_50, this.double_49, class2);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_41, this.double_38);
			DrawHelper.Close(graphicsPath);
			@class.List_0.Add(graphicsPath);
			array[0] = @class;
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: false, Enum32.const_1);
			class2 = DrawHelper.MoveTo(base.double_5, this.double_27);
			class2 = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, 0.0, -5400000.0, class2);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_3, base.t);
			class2 = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, base._3cd4, base.cd4, class2);
			DrawHelper.Close(graphicsPath);
			@class.List_0.Add(graphicsPath);
			array[1] = @class;
			graphicsPath = DrawHelper.PathBegin();
			...
			class2 = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, 0.0, this.double_42, class2);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_41, this.double_38);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_3, this.double_40);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_41, this.double_37);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_41, this.double_33);
			class2 = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_17, this.double_42, this.double_48, class2);
			@class.List_0.Add(graphicsPath);
