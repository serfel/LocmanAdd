...
namespace ns18
{
	internal class Class342 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_16 = Helper.FmlaMultiplyDivide(this.double_13, 29289.0, 100000.0);
			this.double_17 = Helper.FmlaAddDivide(this.double_15, base.double_5, 2.0);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				adjustObject = new Class170(new Class177(this.double_15 / 12700.0, base.t / 12700.0, bool_1: false), "Adj2", 0.0, 50000.0, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 16667.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
