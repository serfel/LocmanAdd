...
namespace ns18
{
	internal class Class191 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_18 = Helper.FmlaMultiplyDivide(this.double_16, 1.0, 4.0);
			...
			class2 = DrawHelper.MoveTo(this.double_20, base.double_7);
			...
			DrawHelper.Close(graphicsPath);
			class2 = DrawHelper.MoveTo(this.double_19, this.double_12);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_19, this.double_13);
			DrawHelper.Close(graphicsPath);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_15, this.double_13);
			DrawHelper.Close(graphicsPath);
			class2 = DrawHelper.MoveTo(this.double_19, this.double_12, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_19, this.double_13);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_14, this.double_13);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_14, this.double_12);
			DrawHelper.Close(graphicsPath);
