...
namespace ns18
{
	internal class Class267 : ShapeObject
	{
		private double double_11;

		public Class267(Shape shape_0)
		{
			base.shape = shape_0;
		...
		internal override void CreateGraphicsPaths()
		{
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, 31750.0, 63500.0);
			DrawHelper.Close(graphicsPath);
			@class.List_0.Add(graphicsPath);
			array[0] = @class;
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: true, Enum32.const_4);
			class2 = DrawHelper.MoveTo(25400.0, 50800.0);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, 38100.0, 50800.0);
			@class.List_0.Add(graphicsPath);
			array[1] = @class;
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: true, Enum32.const_4);
