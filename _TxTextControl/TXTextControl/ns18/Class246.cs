...
namespace ns18
{
	internal class Class246 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_28 = Helper.FmlaMultiplyDivide(base.double_1, this.double_19, 100000.0);
			...
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class170(new Class177(this.double_23 / 12700.0, this.double_27 / 12700.0, bool_1: false), "Adj1", 0.0, this.double_13, num, base.shape, bool_0: true);
				...
				adjustObject = new Class170(new Class177(this.double_22 / 12700.0, base.double_0 / 12700.0, bool_1: false), "Adj2", 0.0, this.double_11, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj3")) ? 25000.0 : base.adj3);
				adjustObject = new Class171(new Class177(base.double_5 / 12700.0, this.double_27 / 12700.0, bool_1: false), "Adj3", 0.0, this.double_15, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj4")) ? 64977.0 : base.adj4);
				adjustObject = new Class171(new Class177(base.double_3 / 12700.0, this.double_28 / 12700.0, bool_1: false), "Adj4", 0.0, this.double_18, num, base.shape, bool_0: false);
				adjustObject.DefaultValue = 64977.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				base.shape.Class174_0.Class172_0[0].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_23 / 12700.0, this.double_27 / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[1].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_22 / 12700.0, base.double_0 / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[2].AdjustRectangle.Class178_0.Class177_1 = new Class177(base.double_5 / 12700.0, this.double_27 / 12700.0, bool_1: false);
