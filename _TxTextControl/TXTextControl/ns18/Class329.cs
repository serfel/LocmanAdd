...
namespace ns18
{
	internal class Class329 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class171(new Class177(base.double_3 / 12700.0, this.double_17 / 12700.0, bool_1: false), "Adj1", 0.0, 100000.0, num, base.shape, bool_0: true);
