...
namespace ns18
{
	internal class Class271 : ShapeObject
	{
		private double double_11;

		public Class271(Shape shape_0)
		{
			base.shape = shape_0;
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_11 = Helper.FmlaMultiplyDivide(base.double_8, 7.0, 8.0);
			...
			class2 = DrawHelper.MoveTo(88900.0, 0.0, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, 88900.0, 101600.0);
			@class.List_0.Add(graphicsPath);
			array[1] = @class;
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: true, Enum32.const_4);
