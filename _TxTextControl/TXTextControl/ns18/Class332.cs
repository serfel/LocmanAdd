...
namespace ns18
{
	internal class Class332 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_17 = Helper.FmlaAddSubtract(base.double_3, this.double_15, 0.0);
			...
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class171(new Class177(base.double_5 / 12700.0, this.double_13 / 12700.0, bool_1: false), "Adj", 0.0, this.double_11, num, base.shape, bool_0: false);
				adjustObject.DefaultValue = 8333.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				base.shape.Class174_0.Class172_0[0].AdjustRectangle.Class178_0.Class177_1 = new Class177(base.double_5 / 12700.0, this.double_13 / 12700.0, bool_1: false);
			}
			...
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_13, base._3cd4, base.cd4, currentPathEndLocation);
			...
			currentPathEndLocation = DrawHelper.ArcTo(graphicsPath, base.double_8, this.double_13, 0.0, base.cd4, currentPathEndLocation);
