...
namespace ns18
{
	internal class Class298 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_15 = Helper.FmlaMultiplyDivide(50000.0, base.double_8, base.double_6);
			this.double_16 = Helper.FmlaPinTo(0.0, base.adj3, this.double_15);
			this.double_17 = Helper.FmlaMultiplyDivide(this.double_16, base.double_6, base.wd2);
			...
			this.double_27 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_26);
			this.double_28 = Helper.FmlaMultiplyDivide(base.double_8, this.double_19, 200000.0);
			this.double_29 = Helper.FmlaAddSubtract(base.double_2, 0.0, this.double_28);
			this.double_30 = Helper.FmlaAddSubtract(base.double_2, this.double_28, 0.0);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				adjustObject = new Class170(new Class177(this.double_29 / 12700.0, base.double_0 / 12700.0, bool_1: false), "Adj4", 0.0, this.double_18, num, base.shape, bool_0: true);
			...
			else
			{
				...
				base.shape.Class174_0.Class172_0[3].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_29 / 12700.0, base.double_0 / 12700.0, bool_1: false);
			}
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_30, base.t);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_30, this.double_23);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_27, this.double_23);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_27, this.double_22);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_5, base.double_7);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_27, this.double_25);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_30, base.double_0);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_29, base.double_0);
