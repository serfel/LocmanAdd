...
namespace ns18
{
	internal class Class340 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_16 = Helper.FmlaMultiplyDivide(base.double_6, this.double_12, 100000.0);
			this.double_17 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_16);
			this.double_18 = Helper.FmlaAddSubtract(base.double_0, 0.0, this.double_16);
			this.double_19 = Helper.FmlaAddSubtract(this.double_13, 0.0, this.double_16);
			this.double_20 = Helper.FmlaIfElse(this.double_19, this.double_13, this.double_16);
			this.double_21 = Helper.FmlaMultiplyDivide(this.double_20, 1.0, 2.0);
			this.double_22 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_21);
			this.double_23 = Helper.FmlaAddSubtract(base.double_0, 0.0, this.double_21);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class170(new Class177(this.double_13 / 12700.0, base.t / 12700.0, bool_1: false), "Adj1", 0.0, 50000.0, num, base.shape, bool_0: false);
				...
				adjustObject = new Class170(new Class177(this.double_17 / 12700.0, base.t / 12700.0, bool_1: false), "Adj2", 0.0, 50000.0, num, base.shape, bool_0: true);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_3, this.double_18);
