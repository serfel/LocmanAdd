...
namespace ns18
{
	internal class Class201 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_17 = Helper.FmlaMultiplyDivide(this.double_16, 1.0, 8.0);
			this.double_18 = Helper.FmlaMultiplyDivide(this.double_16, 5.0, 16.0);
			this.double_19 = Helper.FmlaMultiplyDivide(this.double_16, 5.0, 8.0);
			this.double_20 = Helper.FmlaMultiplyDivide(this.double_16, 11.0, 16.0);
			this.double_21 = Helper.FmlaMultiplyDivide(this.double_16, 3.0, 4.0);
			this.double_22 = Helper.FmlaMultiplyDivide(this.double_16, 7.0, 8.0);
			this.double_23 = Helper.FmlaAddSubtract(this.double_12, this.double_17, 0.0);
			this.double_24 = Helper.FmlaAddSubtract(this.double_12, this.double_18, 0.0);
			this.double_25 = Helper.FmlaAddSubtract(this.double_12, this.double_20, 0.0);
			this.double_26 = Helper.FmlaAddSubtract(this.double_12, this.double_22, 0.0);
			this.double_27 = Helper.FmlaAddSubtract(this.double_14, this.double_18, 0.0);
			...
			class2 = DrawHelper.MoveTo(this.double_14, this.double_24);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_14, this.double_25);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_28, this.double_12);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_14, this.double_25);
			DrawHelper.Close(graphicsPath);
			class2 = DrawHelper.MoveTo(this.double_29, this.double_24, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_15, this.double_23);
			class2 = DrawHelper.MoveTo(this.double_29, base.double_7, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_15, base.double_7);
			class2 = DrawHelper.MoveTo(this.double_29, this.double_25, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_15, this.double_26);
			@class.List_0.Add(graphicsPath);
			array[2] = @class;
			graphicsPath = DrawHelper.PathBegin();
			@class = new Class175(bool_1: true, Enum32.const_4);
