...
namespace ns18
{
	internal class Class364 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_15 = Helper.FmlaMultiplyDivide(50000.0, base.double_1, base.double_6);
			this.double_16 = Helper.FmlaPinTo(0.0, base.adj3, this.double_15);
			this.double_17 = Helper.FmlaMultiplyDivide(this.double_16, base.double_6, base.hd2);
			...
			this.double_22 = Helper.FmlaAddSubtract(base.double_2, 0.0, this.double_20);
			this.double_23 = Helper.FmlaAddSubtract(base.double_2, 0.0, this.double_21);
			this.double_24 = Helper.FmlaAddSubtract(base.double_2, this.double_21, 0.0);
			this.double_25 = Helper.FmlaAddSubtract(base.double_2, this.double_20, 0.0);
			this.double_26 = Helper.FmlaMultiplyDivide(base.double_6, this.double_16, 100000.0);
			this.double_27 = Helper.FmlaAddSubtract(base.double_0, 0.0, this.double_26);
			this.double_28 = Helper.FmlaMultiplyDivide(base.double_1, this.double_19, 200000.0);
			this.double_29 = Helper.FmlaAddSubtract(base.double_7, 0.0, this.double_28);
			...
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class170(new Class177(this.double_23 / 12700.0, this.double_26 / 12700.0, bool_1: false), "Adj1", 0.0, this.double_13, num, base.shape, bool_0: true);
				...
				adjustObject = new Class170(new Class177(this.double_22 / 12700.0, base.t / 12700.0, bool_1: false), "Adj2", 0.0, this.double_11, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj3")) ? 12500.0 : base.adj3);
				adjustObject = new Class171(new Class177(base.double_5 / 12700.0, this.double_26 / 12700.0, bool_1: false), "Adj3", 0.0, this.double_15, num, base.shape, bool_0: false);
				...
				adjustObject = new Class171(new Class177(base.double_3 / 12700.0, this.double_29 / 12700.0, bool_1: false), "Adj4", 0.0, this.double_18, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 48123.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				base.shape.Class174_0.Class172_0[0].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_23 / 12700.0, this.double_26 / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[1].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_22 / 12700.0, base.t / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[2].AdjustRectangle.Class178_0.Class177_1 = new Class177(base.double_5 / 12700.0, this.double_26 / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[3].AdjustRectangle.Class178_0.Class177_1 = new Class177(base.double_3 / 12700.0, this.double_29 / 12700.0, bool_1: false);
			}
			base.shape.Class174_0.Dictionary_0 = null;
			Class175[] array = new Class175[1];
			GraphicsPath graphicsPath = DrawHelper.PathBegin();
			Class175 @class = new Class175(bool_1: true, Enum32.const_5);
			Class177 class2 = DrawHelper.MoveTo(base.double_3, this.double_29);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_25, this.double_26);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_5, this.double_29);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_5, this.double_30);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_23, this.double_30);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_3, this.double_30);
