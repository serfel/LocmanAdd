...
namespace ns18
{
	internal class Class184 : ShapeObject
	{
		...
		public Class184(Shape shape_0)
		{
			base.shape = shape_0;
			base.shape.Class174_0.Class172_0.Clear();
			base.adj1 = Helper.FmlaLiteralValue(18750.0);
			base.adj2 = Helper.FmlaLiteralValue(-8333.0);
			base.adj3 = Helper.FmlaLiteralValue(112500.0);
			base.adj4 = Helper.FmlaLiteralValue(-38333.0);
		...
		internal override void CreateGraphicsPaths()
		{
			...
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj4")) ? (-38333.0) : base.adj4);
				...
				adjustObject.DefaultValue = -38333.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj3")) ? 112500.0 : base.adj3);
