...
namespace ns18
{
	internal class Class209 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			Class175[] array = new Class175[6];
			GraphicsPath graphicsPath = DrawHelper.PathBegin();
			Class175 @class = new Class175(bool_1: false, Enum32.const_5);
			Class177 class2 = DrawHelper.MoveTo(this.double_12, this.double_12);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_3, base.double_0);
			DrawHelper.Close(graphicsPath);
			class2 = DrawHelper.MoveTo(this.double_12, this.double_12, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_13, this.double_12);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_13, this.double_14);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_12, this.double_14);
			DrawHelper.Close(graphicsPath);
			class2 = DrawHelper.MoveTo(base.double_3, base.t, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_12, this.double_12);
			class2 = DrawHelper.MoveTo(base.double_3, base.double_0, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_12, this.double_14);
			class2 = DrawHelper.MoveTo(base.double_5, base.t, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_13, this.double_12);
			class2 = DrawHelper.MoveTo(base.double_5, base.double_0, graphicsPath, @class, out graphicsPath);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_13, this.double_14);
			@class.List_0.Add(graphicsPath);
			array[5] = @class;
