...
namespace ns18
{
	internal class Class235 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_41 = Helper.FmlaAddSubtract(base.double_0, 0.0, this.double_26);
			...
			this.double_44 = Helper.FmlaAddSubtract(base.double_0, 0.0, this.double_23);
			...
			this.double_48 = Helper.FmlaAddSubtract(base._3cd4, this.double_42, 0.0);
			this.double_49 = Helper.FmlaAddSubtract(base._3cd4, 0.0, this.double_47);
			this.double_50 = Helper.FmlaAddSubtract(this.double_47, 0.0, base.cd4);
			this.double_51 = Helper.FmlaAddSubtract(base.cd4, this.double_47, 0.0);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class170(new Class177(this.double_34 / 12700.0, this.double_41 / 12700.0, bool_1: false), "Adj1", 0.0, base.adj2, num, base.shape, bool_0: false);
				...
				adjustObject = new Class170(new Class177(this.double_37 / 12700.0, base.double_0 / 12700.0, bool_1: false), "Adj2", 0.0, this.double_11, num, base.shape, bool_0: true);
				...
				adjustObject = new Class171(new Class177(base.double_5 / 12700.0, this.double_41 / 12700.0, bool_1: false), "Adj3", 0.0, this.double_24, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				...
				base.shape.Class174_0.Class172_0[1].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_37 / 12700.0, base.double_0 / 12700.0, bool_1: false);
			...
			Class177 class2 = DrawHelper.MoveTo(this.double_40, base.double_0);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_37, this.double_41);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_33, this.double_41);
			class2 = DrawHelper.ArcTo(graphicsPath, this.double_17, base.double_1, this.double_48, this.double_43, class2);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_27, base.t);
			class2 = DrawHelper.ArcTo(graphicsPath, this.double_17, base.double_1, base._3cd4, this.double_42, class2);
			...
			class2 = DrawHelper.ArcTo(graphicsPath, this.double_17, base.double_1, this.double_49, this.double_50, class2);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_3, base.double_0);
			class2 = DrawHelper.ArcTo(graphicsPath, this.double_17, base.double_1, base.cd2, this.double_51, class2);
			DrawHelper.Close(graphicsPath);
			@class.List_0.Add(graphicsPath);
			array[1] = @class;
			graphicsPath = DrawHelper.PathBegin();
			...
			class2 = DrawHelper.ArcTo(graphicsPath, this.double_17, base.double_1, this.double_49, this.double_50, class2);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_3, base.double_0);
			class2 = DrawHelper.ArcTo(graphicsPath, this.double_17, base.double_1, base.cd2, base.cd4, class2);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_27, base.t);
			class2 = DrawHelper.ArcTo(graphicsPath, this.double_17, base.double_1, base._3cd4, this.double_42, class2);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_38, this.double_41);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_40, base.double_0);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_37, this.double_41);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_33, this.double_41);
			class2 = DrawHelper.ArcTo(graphicsPath, this.double_17, base.double_1, this.double_48, this.double_43, class2);
			@class.List_0.Add(graphicsPath);
