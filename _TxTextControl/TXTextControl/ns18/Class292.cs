...
namespace ns18
{
	internal class Class292 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_15 = Helper.FmlaAddSubtract(base.double_3, this.double_14, 0.0);
			...
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				adjustObject = new Class170(new Class177(this.double_15 / 12700.0, base.t / 12700.0, bool_1: false), "Adj2", 0.0, this.double_11, num, base.shape, bool_0: false);
				adjustObject.DefaultValue = 50000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, base.double_5, this.double_18);
