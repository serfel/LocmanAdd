...
namespace ns18
{
	internal class Class297 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_16 = Helper.FmlaMultiplyDivide(base.double_1, this.double_12, 200000.0);
			...
			this.double_19 = Helper.FmlaMultiplyDivide(this.double_17, this.double_14, base.hd2);
			...
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				AdjustObject adjustObject = new Class171(new Class177(this.double_15 / 12700.0, this.double_17 / 12700.0, bool_1: false), "Adj1", 0.0, 100000.0, num, base.shape, bool_0: true);
				...
				adjustObject = new Class170(new Class177(this.double_14 / 12700.0, base.t / 12700.0, bool_1: false), "Adj2", 0.0, this.double_11, num, base.shape, bool_0: false);
				adjustObject.DefaultValue = 20000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				base.shape.Class174_0.Class172_0[0].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_15 / 12700.0, this.double_17 / 12700.0, bool_1: false);
				base.shape.Class174_0.Class172_0[1].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_14 / 12700.0, base.t / 12700.0, bool_1: false);
			}
