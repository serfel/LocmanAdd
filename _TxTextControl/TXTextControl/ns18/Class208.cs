...
namespace ns18
{
	internal class Class208 : ShapeObject
	{
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_15 = Helper.FmlaMultiplyDivide(base.double_6, this.double_12, 50000.0);
			this.double_16 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_15);
			this.double_17 = Helper.FmlaMultiplyDivide(base.double_6, this.double_12, 100000.0);
			this.double_18 = Helper.FmlaAddSubtract(base.double_5, 0.0, this.double_17);
			this.double_19 = Helper.FmlaMultiplyDivide(base.double_6, this.double_11, 200000.0);
			this.double_20 = Helper.FmlaAddSubtract(this.double_18, 0.0, this.double_19);
			this.double_21 = Helper.FmlaAddSubtract(this.double_18, this.double_19, 0.0);
			this.double_22 = Helper.FmlaMultiplyDivide(base.double_6, this.double_11, 100000.0);
			this.double_23 = Helper.FmlaAddSubtract(base.double_0, 0.0, this.double_22);
			this.double_24 = Helper.FmlaMultiplyDivide(this.double_21, 1.0, 2.0);
			this.double_25 = Helper.FmlaAddDivide(this.double_23, base.double_0, 2.0);
			this.double_26 = Helper.FmlaAddDivide(this.double_14, base.double_0, 2.0);
			if (base.shape.Class174_0.Class172_0.Count == 0)
			{
				...
				adjustObject = new Class170(new Class177(this.double_16 / 12700.0, base.t / 12700.0, bool_1: false), "Adj2", 0.0, 50000.0, num, base.shape, bool_0: true);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
				num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj3")) ? 25000.0 : base.adj3);
				adjustObject = new Class171(new Class177(this.double_20 / 12700.0, this.double_14 / 12700.0, bool_1: false), "Adj3", 0.0, 50000.0, num, base.shape, bool_0: false);
				adjustObject.DefaultValue = 25000.0;
				base.shape.Class174_0.Class172_0.method_0(adjustObject);
			}
			else
			{
				...
				base.shape.Class174_0.Class172_0[2].AdjustRectangle.Class178_0.Class177_1 = new Class177(this.double_20 / 12700.0, this.double_14 / 12700.0, bool_1: false);
			}
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_20, this.double_14);
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_16, this.double_14);
			...
			class2 = DrawHelper.LnTo(graphicsPath, class2.Double_2, class2.Double_3, this.double_21, this.double_14);
