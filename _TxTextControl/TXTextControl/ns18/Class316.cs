...
namespace ns18
{
	internal class Class316 : ShapeObject
	{
		...
		public Class316(Shape shape_0)
		{
			base.shape = shape_0;
			base.shape.Class174_0.Class172_0.Clear();
			base.adj = Helper.FmlaLiteralValue(29289.0);
		...
		internal override void CreateGraphicsPaths()
		{
			...
			this.double_15 = Helper.FmlaMultiplyDivide(this.double_12, 1.0, 2.0);
			...
			{
				double num = ((base.shape.Class174_0.Dictionary_0 == null || !base.shape.Class174_0.Dictionary_0.ContainsKey("adj")) ? 29289.0 : base.adj);
				...
				adjustObject.DefaultValue = 29289.0;
