...
namespace ns27
{
	internal sealed class Class600 : CustomTypeDescriptor
	{
		private IServiceProvider iserviceProvider_0;

		internal Class600(ICustomTypeDescriptor icustomTypeDescriptor_0, IComponent icomponent_0)
		...
		public override AttributeCollection GetAttributes()
		{
			...
			foreach (Attribute item2 in attributes)
			{
				...
				if (designerAttribute != null && designerAttribute.DesignerBaseTypeName.StartsWith("System.ComponentModel.Design.IDesigner"))
				{
					...
					{
						DesignerAttribute item = new DesignerAttribute("System.Windows.Forms.Design.ControlDesigner, System.Design");
						list.Add(item);
						continue;
					}
				}
