...
namespace ns0
{
	internal class Class50 : CodeGeneratorBase
	{
		public static string string_0 = "digits only, length of input: 11 digits";

		private string string_1 = "000000";
		...
		internal override Class37 GetBarcodeImage(Class38 p_bsSettings, string p_strText)
		{
			...
			text += this.string_3;
			for (int j = 6; j < p_strText.Length; j++)
			{
			...
			string text2 = p_strText + this.short_0;
			Class37 result = @class.method_11(text, text2, new Class15());
			p_bsSettings.String_1 = text2;
			return result;
		}
