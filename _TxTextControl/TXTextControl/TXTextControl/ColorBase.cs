	...
	public class ColorBase
	{
		...
		internal void method_0()
		{
			if (!(this.intptr_0 == IntPtr.Zero))
			{
				...
				for (int i = 0; i < this.int_0; i++)
				{
					array[i] = ((this.m_aiColors[i] == Color.Empty) ? 1073741824 : ((this.m_aiColors[i] == Color.Transparent) ? 1610612736 : Class429.smethod_0(this.m_aiColors[i])));
				}
		...
		internal void method_1()
		{
			if (!(this.intptr_0 == IntPtr.Zero))
			{
				...
				while (num < this.int_0)
				{
					...
					reference = Class429.smethod_2(array[num2]);
					num++;
					num2++;
				}
			}
