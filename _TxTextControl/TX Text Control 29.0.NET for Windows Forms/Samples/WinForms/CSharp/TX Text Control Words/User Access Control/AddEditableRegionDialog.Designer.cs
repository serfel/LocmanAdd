...
{
	partial class AddEditableRegionDialog
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.m_lbUsers.SelectedValueChanged += new System.EventHandler(this.m_lbUsers_SelectedValueChanged);
			// 
			// tableLayoutPanel1
			// 
			...
			this.Name = "AddEditableRegionDialog";
