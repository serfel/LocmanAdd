	...
	public partial class UserAccessDialog : Form, INotifyPropertyChanged {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void BtnGrantAccess_Click(object sender, EventArgs e) {
			...
			if (userInfo != null) {
				...
				var dlgPwd = new UserPromptDialog(Properties.Resources.USER_ACC_DLG_ENTER_PASSWORD, Properties.Resources.USER_ACC_DLG_ENTER_PASSWORD_LABEL, "")
				{
					IsPassword = true,
				...
				if (dlgPwd.ShowDialog(this) == System.Windows.Forms.DialogResult.OK) {
					...
					else Utils.MessageBox.Show(this, Properties.Resources.USER_ACC_DLG_WRONG_PASSWORD, ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				}
			}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void LocalizeDialog() {
			this.Text = Properties.Resources.USER_ACC_DLG_TITLE;
			...
			m_btnGrantAccess.Text = Properties.Resources.USER_ACC_DLG_BTN_GRANT;
			m_btnRevokeAccess.Text = Properties.Resources.USER_ACC_DLG_BTN_REVOKE;
			m_btnCurrentAuthor.Text = Properties.Resources.USER_ACC_DLG_BTN_CURRENTAUTHOR;
