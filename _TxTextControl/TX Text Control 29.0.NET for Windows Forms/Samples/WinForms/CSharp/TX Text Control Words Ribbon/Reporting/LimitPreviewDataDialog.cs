	...
	public partial class LimitPreviewDataDialog : Form {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		public LimitPreviewDataDialog() {
			...
			// Localize
			Text = Properties.Resources.LIMIT_PREVIEW_DATA_DLG_TITLE;
			m_lblText.Text = Properties.Resources.LIMIT_PREVIEW_DATA_DLG_TEXT;
			m_btnOK.Text = Properties.Resources.LIMIT_PREVIEW_DATA_DLG_OK;
			m_btnCancel.Text = Properties.Resources.LIMIT_PREVIEW_DATA_DLG_CANCEL;
		}//Constructor
