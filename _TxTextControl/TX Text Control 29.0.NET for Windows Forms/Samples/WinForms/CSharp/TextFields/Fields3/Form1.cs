...
namespace Fields3 {
    ...
    public class Form1 : System.Windows.Forms.Form {
        ...
        private void InitializeComponent() {
            ...
            this.Name = "Form1";
            this.Text = "Fields3 Sample Program";
        ...
        private void mnuBookmark_Goto_Click(object sender, System.EventArgs e) {
            frmGotoDialog GotoDialog = new frmGotoDialog();

            GotoDialog.tx = textControl1;
        ...
        private void mnuBookmark_Insert_Click(object sender, System.EventArgs e) {
            if (textControl1.Text == "")
                ...
                MessageBox.Show("Cannot insert a bookmark if there is nothing selected.");
            else {
                frmInsertDialog InsertDialog = new frmInsertDialog();
