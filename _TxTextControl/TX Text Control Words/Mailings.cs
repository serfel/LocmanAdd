	...
	public partial class MainWindow : Form {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void InsertMergeField() {
			...
			if (newMergeField.ShowDialog(this, bRTL) == DocumentServer.Fields.DialogResult.OK) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void InsertIfField() {
			...
			if (newIfField.ShowDialog(this, bRTL) == DocumentServer.Fields.DialogResult.OK) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void InsertNextIfField() {
			...
			if (newField.ShowDialog(this, bRTL) == DocumentServer.Fields.DialogResult.OK) {
				textControl.ApplicationFields.Add(newField.ApplicationField);
			}
		}
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void InsertDateField() {
			...
			if (newDateField.ShowDialog(this, bRTL) == DocumentServer.Fields.DialogResult.OK) {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void InsertIncludeTextField() {
			...
			if (newIncludeTextField.ShowDialog(this, bRTL) == DocumentServer.Fields.DialogResult.OK) {
