...
namespace TX_Text_Control_Words {
	...
	static class Program {
		...
		static void Application_ThreadException(object sender, ThreadExceptionEventArgs e) {
			...
			// TX Text Control's Drawings are not available in the Standard Edition
			if (fileNotFoundException != null && fileNotFoundException.FileName.StartsWith("TXDrawing")) {
				MessageBox.Show(Properties.Resources.ERR_NEEDSPROFLICENSE, strProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
				return;
			}
