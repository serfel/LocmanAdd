	...
	public partial class MainWindow {
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void AddOpenSampleTemplateButtons() {
			...
			{
				DisplayMode = IconTextRelation.NoIconLabeled,
				Text = Properties.Resources.APP_MENU_OPEN_SAMPLE_INVOICE,
			...
			{
				DisplayMode = IconTextRelation.NoIconLabeled,
				Text = Properties.Resources.APP_MENU_OPEN_SAMPLE_PACK_LST,
			...
			{
				DisplayMode = IconTextRelation.NoIconLabeled,
				Text = Properties.Resources.APP_MENU_OPEN_SAMPLE_SHIP_LBL,
		...
		**-----------------------------------------------------------------------------------------------------------*/
		private void LocalizeAppMenu() {
			...
			m_lblRecentFilesHeader.Text = Properties.Resources.APP_MENU_RECENT_ITEMS_HEADER;
			m_btnAppMenu_OpenSample.Text = Properties.Resources.APP_MENU_OPEN_SAMPLE;
